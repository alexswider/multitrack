<?php
	 ...
	 * listing a collection of Users objects.  It includes
	 ...
	 *
	 */
	class UsersDataGridGen extends QDataGrid {
		 ...
		 * way of adding a column to this Users datagrid.  The description of a column's
		 * content can be either a text string description of a simple field name
		 * in the Users object, or it can be any QQNode extending from QQN::Users().
		 *
		 ...
		 * sorting using two fields from the Users object.
		 *
		 ...
		 *
		 * @param mixed $mixContent string or QQNode from Users
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Users::QueryCount($objConditions);
			}
			...
			// Set the DataSource to be a Query result from Users, given the clauses above
			$this->DataSource = Users::QueryArray($objConditions, $objClauses);
		}

		/**
		 * Used internally by the Meta-based Add Column tools.
		 *
		 * Given a QQNode or a Text String, this will return a Users-based QQNode.
		 * It will also verify that it is a proper Users-based QQNode, and will throw an exception otherwise.
		 *
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				if ($mixContent->_RootTableName == 'users') {
					...
					throw new QCallerException('Content QQNode has a root table of "' . $mixContent->_RootTableName . '". Must be a root of "users".');
			} else if (is_string($mixContent)) switch ($mixContent) {
				case 'Id': return QQN::Users()->Id;
				case 'Name': return QQN::Users()->Name;
				case 'FbId': return QQN::Users()->FbId;
				case 'Ip': return QQN::Users()->Ip;
				case 'Avatar': return QQN::Users()->Avatar;
				case 'LastLogged': return QQN::Users()->LastLogged;
				default: throw new QCallerException('Simple Property not found in UsersDataGrid content: ' . $mixContent);
