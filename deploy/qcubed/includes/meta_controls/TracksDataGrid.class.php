<?php
	require(__META_CONTROLS_GEN__ . '/TracksDataGridGen.class.php');

	/**
	 * This is the "Meta" DataGrid customizable subclass for the List functionality
	 * of the Tracks class.  This code-generated class extends
	 * from the generated Meta DataGrid class which contains a QDataGrid class which
	 * can be used by any QForm or QPanel, listing a collection of Tracks
	 ...
	 *
	 */
	class TracksDataGrid extends TracksDataGridGen {
	}
?>