<?php
	...
	abstract class SamplesEditFormBase extends QForm {
		...
		/**
		 * @var SamplesMetaControlGen mctSamples
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the SamplesMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctSamples = SamplesMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/samples_list.php');
		}
	}
?>
