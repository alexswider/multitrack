<?php
	 ...
	 */
	abstract class SamplesDataEditFormBase extends QForm {
		// Local instance of the SamplesDataMetaControl
		/**
		 * @var SamplesDataMetaControlGen mctSamplesData
		 */
...
//		protected function Form_PreRender() {}
		...
		protected function Form_Create() {
			...
			// Use the CreateFromPathInfo shortcut (this can also be done manually using the SamplesDataMetaControl constructor)
			// MAKE SURE we specify "$this" as the MetaControl's (and thus all subsequent controls') parent
			$this->mctSamplesData = SamplesDataMetaControl::CreateFromPathInfo($this);
		...
		protected function RedirectToListPage() {
			QApplication::Redirect(__VIRTUAL_DIRECTORY__ . __FORM_DRAFTS__ . '/samplesdata_list.php');
		}
	}
?>
