<?php
	...
	require(__FORMBASE_CLASSES__ . '/RoomsListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class RoomsListForm extends RoomsListFormBase {
...
//		protected function Form_Create() {}
	...
	// rooms_list.tpl.php as the included HTML template file
	RoomsListForm::Run('RoomsListForm');
?>