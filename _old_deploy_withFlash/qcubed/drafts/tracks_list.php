<?php
	...
	require(__FORMBASE_CLASSES__ . '/TracksListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class TracksListForm extends TracksListFormBase {
...
//		protected function Form_Create() {}
	...
	// tracks_list.tpl.php as the included HTML template file
	TracksListForm::Run('TracksListForm');
?>