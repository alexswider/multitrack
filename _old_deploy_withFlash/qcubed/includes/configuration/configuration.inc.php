...
if (!defined('SERVER_INSTANCE')) {
	...
	switch (SERVER_INSTANCE) {
		...
		case 'prod':
			 ...
			 */
			define ('__DOCROOT__', '/var/www/vhosts/mingcompany.com/prototypes');
			define ('__VIRTUAL_DIRECTORY__', '');
			define ('__SUBDIRECTORY__', '/multitrack/qcubed');
			...
			define('DB_CONNECTION_1', serialize(array(
				...
				'server' => 'localhost',
				'port' => null,
				'database' => 'ming_multitrack',
				'username' => 'admin_multitrack',
				'password' => 'dupa.8',
				'caching' => false,
				'profiling' => false)));
