<?php
	...
	require(__FORMBASE_CLASSES__ . '/SamplesListFormBase.class.php');
	 ...
	 * @subpackage Drafts
	 */
	class SamplesListForm extends SamplesListFormBase {
...
//		protected function Form_Create() {}
	...
	// samples_list.tpl.php as the included HTML template file
	SamplesListForm::Run('SamplesListForm');
?>