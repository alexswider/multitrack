<?php
	...
	class NewsletterDataGridGen extends QDataGrid {
		...
		public function MetaDataBinder() {
			...
			if ($this->Paginator) {
				$this->TotalItemCount = Newsletter::QueryCount($objConditions);
			}
			...
			$this->DataSource = Newsletter::QueryArray($objConditions, $objClauses);
		}
		...
		protected function ResolveContentItem($mixContent) {
			if ($mixContent instanceof QQNode) {
				...
				case 'UserName': return QQN::Newsletter()->UserName;
