...
if (!defined('SERVER_INSTANCE')) {
	...
	switch (SERVER_INSTANCE) {
		...
		case 'prod':
			 ...
			 */
			define ('__DOCROOT__', '/var/www/vhosts/kitchendev.com/httpdocs/learnnorwegian');
			define ('__VIRTUAL_DIRECTORY__', '');
			define ('__SUBDIRECTORY__', '/admin');
			...
			define('DB_CONNECTION_1', serialize(array(
				...
				'server' => 'localhost',
				'port' => null,
				'database' => 'aswiders_learnNorwegian',
				'username' => 'admin_learnNorw',
				'password' => 'dupa.8',
				'caching' => false,
				'profiling' => false)));
